...
\title {9.- Implementación (Practica 2)}
...
\section{Objetivo}
Crear una página con las secciones de Información de contacto, Acerca de mi, Experiencia Laboral, Formación Académica y Portafolio.



\section{Codigo}

Repositorio Github:  \url{https://github.com/SopaconK/7mo_CETI/tree/main/Web/7.Maqueta}


\section{Evidencia}

\begin{center}
    \includegraphics[scale=0.4]{evid1.png}
\end{center}

\begin{center}
    \includegraphics[scale=0.4]{evid2.png}
\end{center}

\begin{center}
    \includegraphics[scale=0.4]{evid3.png}
\end{center}


\section{Conclusión}

En esta practica utilizamos JS para la realización del slider, para esto usamos un arreglo con las direcciones de las distintas imagenes que queremos poner en el carrusel y 
un indice que tome en cuenta donde vamos, usando modulo para simular una lista circular. \\

También usamos distintas herramientas de CSS para hacer el parallax.  \\
